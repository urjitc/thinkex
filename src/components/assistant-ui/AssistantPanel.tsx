...
function CreateFromPromptHandler({
  ...
  useEffect(() => {
    ...
    const wrapped = `Create a workspace about: ${createFrom} and please create relevant items (notes, flashcards, quizzes, and one quality YouTube video after searching)`;
