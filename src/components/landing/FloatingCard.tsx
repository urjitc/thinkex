            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <h3 className="font-medium text-sm md:text-base mb-1 truncate text-muted dark:text-muted-foreground">{data.title || "New Folder"}</h3>
                        <p className="text-xs text-muted dark:text-muted-foreground">{data.itemCount || 0} items</p>
                    </div>
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-2 mb-3 pb-2 border-b">
                        ...
                        <h3 className="font-semibold text-xs md:text-sm truncate text-muted dark:text-muted-foreground">{data.title || "Quiz"}</h3>
                    </div>
                        ...
                        {['A', 'B', 'C', 'D'].map((option, i) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    i === 1 ? "bg-green-500/30 border border-green-500/50" : "bg-muted/50 dark:bg-muted-foreground/20 border"
                                )}
                            >
                                <span className={cn(
                                    "w-4 h-4 rounded-sm flex items-center justify-center text-[9px] font-medium",
                                    i === 1 ? "bg-green-500/40 text-green-300" : "bg-muted/50 dark:bg-muted-foreground/20 text-muted dark:text-muted-foreground"
                                )}>
                                    {option}
                                </span>
                                <span className={cn(i === 1 ? "text-green-300/90" : "text-muted dark:text-muted-foreground")}>
                                    Option {option}
                                </span>
                            </div>
                        ))}
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-3 pb-2 border-b">
                        <h3 className="font-semibold text-xs md:text-sm truncate w-3/4 text-muted dark:text-muted-foreground">{data.title || "Untitled Note"}</h3>
                    </div>
            ...
            >
                ...
                >
                    ...
                    <div className="p-3 border-b flex items-center gap-2" style={{ backgroundColor: getCardColorCSS(baseColor, 0.2) }}>
                        ...
                        <h3 className="font-medium text-xs truncate flex-1 text-muted dark:text-muted-foreground">{data.title || "Document.pdf"}</h3>
                    </div>
